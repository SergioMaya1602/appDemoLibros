...
function AddLibroContent(props) {
                    ...
                    <Row>
                        ...
                        <Col xs={12} md={3} className="mt-3">
                            <GetInput
                                label="Autor*"
                                value={form.autor}
                                tooltipDescrip="Autor del libro"
                                name="autor"
                        ...
                        <Col xs={12} md={3} className="mt-3">
                            <GetInput
                                label="Título*"
                                tooltipDescrip="Título del libro"
                                value={form.titulo}
                                name="titulo"
                                handleChange={handleChangeForm}
                                isRequired={true}
                        ...
                        <Col xs={12} md={3} className="mt-3">
                            <GetInput
                                label="Editorial*"
                                tooltipDescrip="Editorial del libro"
...
function GetInput(props) {
    ...
    const { label, value, name, handleChange, tooltipDescrip, min, type, isRequired, placement, show = true, isReadOnly = false, isTextArea = false, style = null } = props
...
export default AddLibroContent